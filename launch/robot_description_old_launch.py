...
def launch_setup(context: LaunchContext) -> list:
    ...
    vision_launch_params = yaml.safe_load(open(os.path.join(
    ...
    robot_gimbal_description = Command(['xacro ', os.path.join(
        ...
        ' xyz:=', vision_launch_params['odom2camera']['xyz'], ' rpy:=', vision_launch_params['odom2camera']['rpy']])
